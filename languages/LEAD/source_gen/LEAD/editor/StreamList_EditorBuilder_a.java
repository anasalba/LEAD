...
/*package*/ class StreamList_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public StreamList_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private static class streamsListHandler_bk7io7_a0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public streamsListHandler_bk7io7_a0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(streamsListHandler_bk7io7_a0.this.getNode(), MetaAdapterFactory.getContainmentLink(0xebf7f592fe9245eeL, 0xaac5a2d99c69cfa1L, 0x45a737ba1a53ede4L, 0x45a737ba1a53ede5L, "streams")));
      try {
